...
const BookAppointmentModal = ({
  ...
  const StepSchedule = () => (
    <div className="p-4 sm:p-6 flex flex-col gap-5 overflow-y-auto remove-scrollbar flex-1">
      ...
      {/* On desktop: side-by-side calendar + slots. On mobile: stacked */}
      <div className="flex flex-col lg:flex-row gap-5">

        {/* Calendar side */}
        <div className="bg-white/70 backdrop-blur-md border border-[#d8e1ea] rounded-3xl p-3 sm:p-4 shadow-sm flex flex-col gap-4 lg:w-[300px] shrink-0">
          ...
          <Card className="w-full rounded-2xl border border-[#d9e3ec] shadow-sm bg-white overflow-hidden">
        ...
        {/* Time slots side */}
        <div className="flex-1 min-w-0 bg-white/70 backdrop-blur-md border border-[#d8e1ea] rounded-3xl p-3 sm:p-4 shadow-sm flex flex-col gap-4">
    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className={cn(
          ...
          // Mobile: fullscreen, no rounding
          "h-[100dvh] w-screen rounded-none",
          // Tablet (sm): floating, rounded, max height
          "sm:h-auto sm:max-h-[95vh] sm:w-[92vw] sm:rounded-2xl sm:max-w-[640px]",
          // Desktop (lg): wider two-column-friendly size
