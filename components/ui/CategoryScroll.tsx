      ...
      >
        ...
        >
          {doubled.map((category, idx) => (
            ...
            >
              {/* Fixed-height image area with inner padding to normalise visual size */}
              ...
              {/* Label always pinned to the bottom */}
              <h2 className="font-medium text-[#203C67] text-base text-center
                             leading-tight w-full truncate flex-shrink-0">
                {category.tag}
              </h2>
            </div>
          ))}
